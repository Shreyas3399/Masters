...
count1, count2 = 0, 0
neighbors = {"Comet" : (7, "Comet"), "Glados" : (5  , "Glados")}
default = {"Comet" : (7, "Comet"), "Glados" : (5, "Glados"), "self" : "Queeg"}
router_id = "Queeg"
...
def print_table(table):
    print("Routing Table for Queeg",)
    print("Destination\tCost\t\tNexthop")
    print("========================================")
    for each in table:
        if each != "self":
            print(each,"\t\t",table[each][0],"\t\t",table[each][1])
    print("========================================")
