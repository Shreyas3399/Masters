...
class NetworkTopo( Topo ):
    ...
    def build( self, **_opts ):
        ...
        defaultIP = '20.10.100.0'  # IP address for r0-eth1
        ...
        self.addLink( switch, router1, intfName2='r0-eth1',
                      params2={ 'ip' : defaultIP } )  # for clarity
        self.addLink( switch, router2, intfName2='r0-eth2',
                      params2={ 'ip' : '172.16.0.1/12' } )
        self.addLink( switch, router3, intfName2='r0-eth3',
        ...
        for h, s in [ (h1, switch), (h2, switch), (h3, switch) ]:
            self.addLink( h, s )
